...
Their diminished success in the adjective only condition but recovered contrast inferences after the opposites exposure further suggests that the linguistic alternatives hypothesis may explain this pattern of performance; children can form pragmatic inferences when they recognize word choice as conveying implicit contrasts with relevant implicit alternatives, but fail when they cannot access implied lexical alternatives spontaneously from adjective use alone.   In other words, children can recognize adjective use as conveying information about implicit contrast dimensions, but unlike adults, they may need additional cues supporting these inferences until they gain enough experience to form these inferences on their own. 

The opposites exposure may help children in a few ways. Visually, images of familiar objects may make contrasts more salient. Aurally, hearing named opposites may help children better retrieve these terms, attend to the relevant property categories, or select matches for these specific lexical items.  Attentionally, portraying contrast pairs may support children's ability to make comparison judgements \cite{christie2010}.  In future work, we hope to identify how each of these contributions may impact children's inferences about implied contrast from word choice.
