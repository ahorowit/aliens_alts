...
Why do children fail to make scalar implicatures despite their familiarity with the component words? This failure is especially confusing given children's proficiency in making other forms of pragmatic inference in reference disambiguation \cite<e.g.>{clark1990, diesendruck2001, akhtar1996}.  Though both reference disambiguation and implicature are inferences about speakers' lexical choices, a critical difference between them is the space of possible alternative interpretations. In reference selection tasks, the possible alternatives are typically referents that are physically present and hence easy to reason about; in implicature tasks the possible alternatives are typically \emph{unsaid} terms that may be hard to summon to mind. We refer to the idea that implicatures are hard because of the difficulty summoning to mind the alternative possible utterances as the \emph{linguistic alternatives hypothesis}, developed by Barner and colleagues \cite{barner2011, brooks2013}
